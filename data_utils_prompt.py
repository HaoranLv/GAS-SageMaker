...
#             # c is the sentiment polarity
            c = sentword2opinion[sp]         # 'POS' -> 'good'

            one_tri = f"It is {c} because {at} is {ot}"
...
class ABSADataset(Dataset):
    def __init__(self, tokenizer, data_dir, data_type, task, max_len=128):
        ...
        self.data_path = f'/opt/ml/input/data/{task}/{data_dir}/{data_type}.txt' #f'data/{data_dir}/{data_type}.txt'
